...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-D5fjIs1J.mjs");
...
const manifest = {
  "bdc12cfac863d3cdd2a1989926c1047340bb6ca839acfa0b7000ead3a7fbf3b2": {
    functionName: "fetchAllTimeframesFn_createServerFn_handler",
    importer: () => import("./market-data-oT4HrwG0.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DGfBgTIU.mjs"),
    import("./start-fticOXGJ.mjs"),
